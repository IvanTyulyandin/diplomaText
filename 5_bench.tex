...
20.04, процессором \name{Intel Core i7-6700} с 4-мя ядрами по 3.40ГГц, 64 Гб оперативной памяти, видеокартой 
...
\begin{tabular}{l|c}%
    ...
    \csvreader[separator=tab,head to column names]{Viterbi_spec_bench_emit_3_3500_20.dat}{}% use head of csv as column names
...
%%        \addplot[mark=square,black,thick] table[x=States,y=GraphBLAS_spec_3_prep] {Viterbi_spec_bench_emit_3_7000_20.dat};                  				\legend{ур. 1 спец., ур. 2 спец.}
%      \end{axis}
%    \end{tikzpicture}
...
%%        \addplot[mark=square,black,thick] table[x=States,y=CUSP_spec_3_prep] {Viterbi_spec_bench_emit_3_7000_20.dat};                  		
%		\legend{ур. 1 спец.}
%      \end{axis}
%    \end{tikzpicture}
