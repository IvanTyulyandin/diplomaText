...
\name{Hyperledger Burrow}~\cite{HLBurrow} --- проект \name{Hy\-per\-led\-ger Fo\-un\-da\-ti\-on}, позволяющий развернуть приватную блокчейн сеть с возможностью выполнения смарт-контрактов.
Ключевые особенности проекта: алгоритм консенсуса Tendermint~\cite{Tendermint}, наличие программного интерфейса для удаленного вызова процедур, возможность выставлять права доступа и виртуальная машина для смарт-контрактов, написанных на байткоде \name{EVM}.
